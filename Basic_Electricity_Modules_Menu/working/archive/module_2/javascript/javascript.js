...
.to([IequalsEoverR_hide], 1, {autoAlpha:1, delay:3})
// .to([IequalsPoverE_hide,IEqualssquareRootPoverR_hide], 1, {autoAlpha:0, delay:8})

//Highlight volts
.to(calculations1vT_hide, 1, {fill:"red", delay:6.5})
...
.to(dishwasherDiagram, 1, {autoAlpha:0, delay:7})
.from(ohmsLawSearch, 1, {autoAlpha:0, delay:-1})
