...
TweenMax.set([path32_copy,path3961_copy,path3963_copy,path3965_copy], {autoAlpha:0})
TweenMax.set(schematic, {x:'-=50'})
var slideTl = new TimelineMax({paused:true});
slideTl
.to(schematic,1.5,{x:217, y:-509, scaleX:1.8415725617280227, scaleY:1.8415725617280227, transformOrigin: "50% 50%",ease:Power0.easeNone, onComplete: updateLineNumber, onCompleteParams:[new Error().lineNumber]},"+=0")
.set(text0, {text:"Power Cord", className:"h3", x:670, y:-193}).to([text0],1, {autoAlpha:1})
.set([receptacleBorder_copy], {stroke:red})
.staggerFromTo([receptacleBorder_copy], 1, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone})
.to(['#text0'],1, {autoAlpha:0, delay:1})
.to([receptacleBorder_copy], .5, {drawSVG: '0%', ease: Power0.easeNone, delay:-1})

.set(text1, {text:"Long prong is neutral.", className:"h3 blackBg", x:600, y:-200}).to([text1],1, {autoAlpha:1})
.set([path4425_copy], {stroke:red})
.staggerFromTo([path4425_copy], .1, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone})

.to(['#text1'],1, {autoAlpha:0, delay:2})
.to([path4425_copy], .5, {drawSVG: '0%', ease: Power0.easeNone},"-=1")


.set(text2, {text:"Short prong is L1.", className:"h3 blackBg", x:620, y:-200}).to([text2],1, {autoAlpha:1})
.set([path36_copy], {stroke:red})
.staggerFromTo([path36_copy], .1, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone})

.to(['#text2'],1, {autoAlpha:0, delay:2})
...
.set([path22], {stroke:red})
// .staggerFromTo([path32_copy], .7, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone},.7)

.set(text7, {text:"GND does not operate loads.", className:"h3 blackBg", x:300, y:-174}).to([text7],1, {autoAlpha:1})

.to(['#text3',text7],1, {autoAlpha:0, delay:3.5})
.set([path22], {stroke:black})
.to([path32_copy], .5, {drawSVG: '0%', ease: Power0.easeNone, delay:1.5})

.set(text4, {text:"L1", className:"h3 blackBg", x:600, y:-142}).to([text4],1, {autoAlpha:1})
...
.set(text5, {text:"Female Connector", className:"h3 blackBg", x:209, y:173}).to([text5],1, {autoAlpha:1, delay:3})


.to(['#text5',text4],1, {autoAlpha:0, delay:2})
...
.set(text8, {text:"Component and connector<br>locator found on mini manual.<br>", className:"h3 blackBg", x:473, y:-181}).to([text8],1, {autoAlpha:1,delay:3})
.from(['#diagram'],1, {autoAlpha:0},"-=1")
//
.to(['#text8'],1, {autoAlpha:0, delay:2})
.staggerFromTo([diagram_callOut1], 2, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone,delay:2})
.set(text9, {text:"Connector location with pin out.<br>", className:"h3 blackBg", x:466, y:70}).to([text9],1, {autoAlpha:1})


.to([text6,'#text8',text9,diagram],1, {autoAlpha:0, delay:3})
...
.to(['#text10'],1, {autoAlpha:0, delay:4})
.set(text11, {text:"Single Pole", className:"h3 blackBg", x:210, y:86})
...
.set(text12, {text:"Single Throw", className:"h3 blackBg", x:390, y:106, delay:1})
...
.set(text13, {text:"Pole below dot indicates switch<br>closes on temperature rise.<br>", className:"h3 blackBg", x:306, y:200}).to([text13],1, {autoAlpha:1, delay:2})


.to([text11,text12,text13,path8,path7],1, {autoAlpha:0, delay:2})
...
.set(text15, {text:"Defrost Timer", className:"h3 blackBg", x:425, y:1}).to([text15],1, {autoAlpha:1})

.to(['#text15',path_164_copy],1, {autoAlpha:0, delay:3})

.set([path296_copy], {stroke:orange}).staggerFromTo([path296_copy], .7, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone,delay:3})
.set(text16, {text:"Timer Motor", className:"h3 blackBg", x:306, y:203}).to([text16],1, {autoAlpha:1, delay:0})
...
.set(text18, {text:"Neutral", className:"h3 blackBg", x:665, y:-272}).to([text18],1, {autoAlpha:1})
.to(['#text16',text17,path9],1, {autoAlpha:0, delay:0})
...
.set([path1077_copy], {stroke:red}).staggerFromTo([path1077_copy], .7, {drawSVG:'100% 100%'}, {drawSVG: '100% 0%', ease: Power0.easeNone, delay:3})
.set(text19, {text:"Internal Timer Connection", className:"h3 blackBg", x:165, y:113}).to([text19],1, {autoAlpha:1})
...
.set(text20, {text:"<center>Timer Switch<br>SPDT<c>", className:"h3 blackBg", x:333, y:-23}).to([text20],1, {autoAlpha:1})
...
.to(['#text19'],1, {autoAlpha:0})
.set(["#path162-5_copy"], {stroke:red}).staggerFromTo(["#path162-5_copy"], .5, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone,delay:2})
...
.set(text21, {text:"Evaporator Fan Motor", className:"h3 blackBg", x:480, y:-98}).to([text21],1, {autoAlpha:1})


.set(text22, {text:"Infinite Resistance", className:"h3 blackBg", x:619, y:16, delay:2})
...
.to([text22,path10,text21],1, {autoAlpha:0, delay:10})

.set([path1587_copy], {stroke:blue}).staggerFromTo([path1587_copy], .7, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone,delay:2},.7)
.set(text23, {text:"Neutral", className:"h3 blackBg", x:881, y:4}).to([text23],1, {autoAlpha:1})


.to(['#text23'],1, {autoAlpha:0,delay:1.5})
...
.set([path1370_copy], {stroke:blue}).staggerFromTo([path1370_copy], .7, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone, delay:12})
.set(text26, {text:"Neutral", className:"h3 blackBg", x:1075, y:-142}).to([text26],1, {autoAlpha:1})


.to(['#text26', '#text24'],1, {autoAlpha:0, delay:1})
.to(schematic,1,{x:177, y:-436, scaleX:1.8415725617280227, scaleY:1.8415725617280227, transformOrigin: "50% 50%",ease:Power0.easeNone})
...
.to([path90_copy,text27],1, {autoAlpha:0, delay:2})
...
.to([text28],1, {autoAlpha:0, delay:7})
.set([path2803_copy], {stroke:red}).staggerFromTo([path2803_copy], .5, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone, delay:2})
.set([path116_copy], {stroke:red}).staggerFromTo([path116_copy], .5, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone})
.set(text30, {text:"Overload", className:"h3 blackBg", x:720, y:-133}).to([text30],1, {autoAlpha:1})

.set(text31, {text:"Protects compressor on stall.<br>", className:"h3 blackBg", x:509, y:-87}).to([text31],1, {autoAlpha:1, delay:2})


.to([text30,text31],1, {autoAlpha:0,delay:3})
.set([path142_copy], {stroke:red}).staggerFromTo([path142_copy], .7, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone, delay:3})
...
.to([path1094_copy,text32],1, {autoAlpha:0, delay:2})
...
.set(text33, {text:"Run Winding", className:"h3 blackBg", x:700, y:-120}).to([text33],1, {autoAlpha:1})
...
.set(text34, {text:"<center>PTC Device</center>", className:"h3 blackBg", x:700, y:-4}).to([text34],1, {autoAlpha:1, delay:0})


.set(text35, {text:"Low resistance initially. As temperature<br>increases, resistance goes up.<br>", className:"h3 blackBg", x:410, y:74}).to([text35],1, {autoAlpha:1,delay:24})
.set([path3959_copy], {stroke:blue}).staggerFromTo([path3959_copy], 3, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone, delay:3},.7)
...
.to(["#path1132-2_copy",path3959_copy, path1606_copy], 5, {autoAlpha:0, delay:7})
.to([text34,text35,text36],1, {autoAlpha:0, delay:0})
...
.to([defrostControlWiper,defrostControlWiper_copy],1, {rotation:-30})
.to(['#path162-5_copy',path3954_copy,'#path1583-6_copy','#path1587-7_copy',path1587_copy],1, {autoAlpha:0, delay:0})
.set([path2750_copy], {stroke:red}).staggerFromTo([path2750_copy], .7, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone,delay:4.5},.7)
...
.to(['#text39'],1, {autoAlpha:0,delay:2})
...
.set(text41, {text:"Opens on temperature rise.", className:"h3 blackBg", x:615, y:-104}).to([text41],1, {autoAlpha:1, delay:5})


.to([text40,text41],1, {autoAlpha:0, delay:5})
.set([path348_copy], {stroke:blue}).staggerFromTo([path348_copy], .7, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone, delay:3})



.to([text41],1, {autoAlpha:0, delay:2})
...
.set(text42, {text:"Door Switch<br>", className:"h3 blackBg", x:357, y:23}).to([text42],1, {autoAlpha:1})


.to(['#text42'],1, {autoAlpha:0, delay:2})
.to([path200,path200_copy],1, {rotation:-25, delay:3})
...
.set(text43, {text:"FF Light", className:"h3 blackBg", x:675, y:25}).to([text43],1, {autoAlpha:1})
...
.set([path4023_copy], {stroke:red}).staggerFromTo([path4023_copy], .7, {drawSVG:'0% 0%'}, {drawSVG: '0% 100%', ease: Power0.easeNone,delay:3},.7)
...
.to([text45,text46],1, {autoAlpha:0, delay:1})
