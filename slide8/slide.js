...
TweenMax.to(diagram1_hide, 1, {x:-140, y:100})
...
.to(calculations1rT_hide, 1, {autoAlpha:1, delay:.5})
.to(diagram1r1Callout, 1, {fill:"red", delay:0})
.to(diagram1r2Callout, 1, {fill:"red", delay:0})
.to(diagram1h1Callout, 1, {fill:"red", delay:0})
.to(calculations1rTAnswer_hide, 1, {autoAlpha:1, delay:5.5})
.to([diagram1r1Callout,diagram1r2Callout,diagram1h1Callout], 1, {fill:"black", delay:-1})

//Highlight total current
.to(calculations1iT_hide, 1, {autoAlpha:1, delay:2})
